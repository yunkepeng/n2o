...
#new
df1_all_test$log_n2o_co2 <- df1_all_test$logr/df1_all_test$log_co2
df1_all_test2 <- na.omit(df1_all_test[,c("log_n2o_co2","Nfer_a","min_fapar","mean_fapar","max_fapar","PPFD_total_a",
                                   "Tg","vpd_a","orgc_a")])
stepwise_lm(df1_all_test2,"log_n2o_co2")[[1]]
stepwise_lm(df1_all_test2,"log_n2o_co2")[[2]]
...
#new, set as logr/dT
df2_all_test$logr_dT <-df2_all_test$logr/df2_all_test$dT
df2_all_test2 <- na.omit(df2_all_test[,c("Nfer_a","min_fapar","mean_fapar","max_fapar","PPFD_total_a",
                                   "vpd_a","orgc_a","logr_dT")])#remove ndep_a

stepwise_lm(df2_all_test2,"logr_dT")[[1]]
summary(lm(logr_dT~orgc_a,df2_all_test2))
